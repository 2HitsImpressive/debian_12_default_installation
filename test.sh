...
apt remove -y lxqt-powermanagement qlipper lxqt-notificationd lxqt-runner xscreensaver xscreensaver-data xscreensaver-data-extra xscreensaver-gl gvfs gvfs-daemons gvfs-fuse gvfs-backends pulseaudio avahi-daemon avahi-utils upower at-spi2-core at-spi2-common 
